...
abstract public class Account {   //Parent
	...
	public String toString() {
		return "Account [FName=" + FName + ", LName=" + LName + ", mob=" + mob + ", email=" + email + ", bal=" + bal
				+ ", id=" + id + "]";
	}

	abstract public int withdrawMoney(double bal, double wm);
	abstract public int depositMoney();
...
//			sc.nextLine();
			...
			if (flag) {
				Account a =new Saving(accType, fname, lname, mob, email, bal);
				custArr[i] = a;
			} else {
				break;
			}
