...
public class TestStudentManagementSystem {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 7 -> {
				System.out.println("Enter Student's Percentage to Delete Student...");
				float per = sc.nextFloat();
				boolean s = studService.deleteByPer(per);
				if (s) {
			...
			case 8 -> {
				System.out.println("Enter Student's ID to Delete Student...");
				int id = sc.nextInt();
			...
			case 9 -> {
				System.out.println("Enter Student's Name to Delete Student...");
				sc.nextLine();
				String id = sc.nextLine();
				boolean s = studService.deleteByName(id);
				if (s) {
					System.out.println("Student with Name : " + id + " is Deleted Successfully.");
				} else {
					System.out.println("Sorry Something Went Wrong or Didn't find Anything...");
				}
			}
			...
			case 10 -> {
				List<Student> sSet = studService.sortById();
				if (sSet.size() != 0) {
					System.out.println("-----------------------------------------------------");
			...
			case 11 -> {
				List<Student> sSet = studService.sortByName();
				if (sSet.size() != 0) {
					System.out.println("-----------------------------------------------------");
			...
			case 12 -> {
				List<Student> sSet = studService.sortByPerc();
				if (sSet.size() != 0) {
					System.out.println("-----------------------------------------------------");
